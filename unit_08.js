...
function t12() {
    ...
    let result = '';
    while (i < div.length) {
        result = div[i].style.margin = '10px';
        result = div[i].style.background = 'orange';
        result = ' ';
        i++;
    }
...
function t13() {
    ...
    while (i < input.length) {
        result = input[0].value = 1;
        result = input[1].value = 2;
        result = input[2].value = 3;
        result = '';
        i++;
    }
